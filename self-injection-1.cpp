...
int main(int argc, char **argv){
    ...
    LPVOID allocated_mem = VirtualAlloc(NULL,sizeof(buf),(MEM_COMMIT|MEM_RESERVE),PAGE_EXECUTE_READWRITE);
    if(allocated_mem == NULL){printf("failed to allocate memory:%d\n",GetLastError());return 1 ;  }
    printf("Memory allocated at address: 0x%p \n",allocated_mem);
    RtlCopyMemory(allocated_mem,buf,sizeof(buf));
    ...
    if (hThread == NULL){ printf("failed to create thread: %d \n",GetLastError());  return 1 ;   }
